...
(function (global) {
  ...
  const MESSAGES = {
    en: {
      ...
      'event.codex': 'Event Codex',
      'event.search': 'Search events...',
      'event.kindAll': 'Kind: All',
      'event.kindNormal': 'Normal',
      'event.kindSpecial': 'Special',
      'event.seenAll': 'Status: All',
      'event.seenSeen': 'Seen',
      'event.seenUnseen': 'Not seen',
    ...
    zh: {
      ...
      'event.kindAll': '类型: 全部',
      'event.kindNormal': '普通',
      'event.kindSpecial': '特殊',
      'event.seenAll': '状态: 全部',
      'event.seenSeen': '已收录',
      'event.seenUnseen': '未收录',
      'gb.openCodex': '导本图鉴',
      'gb.langShowZh': '显示译文',
