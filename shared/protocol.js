...
export const TYPE_DECK_SUMMONS = 'deck-summons';         // deck_summon from proceed/incident
...
export const DATA_UNLOCK_WEAPON = 'unlockWeapon';
export const DATA_UNLOCK_SUMMON = 'unlockSummon';
export const DATA_PARTY_DECK = 'partyDeck';
